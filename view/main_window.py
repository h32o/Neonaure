...
from PyQt6.QtWidgets import (
    QApplication, QDialog, QMainWindow, QFormLayout, QSpinBox,
    QDoubleSpinBox, QDialogButtonBox, QWidget, QVBoxLayout,
    QMessageBox, QLabel, QPushButton, QHBoxLayout, QFileDialog
)
from PyQt6.QtCore import Qt, QTimer, pyqtSignal
from PyQt6.QtGui import QKeySequence, QPixmap, QPainter
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.grid_container = BackgroundWidget()
        ...
        self.game_layout.addWidget(self.grid_container, 1)
